...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        sparse_inputs_slots = config.get('hyper_parameters.sparse_inputs_slots')

        flen_model = net.FLENLayer(sparse_feature_number, sparse_feature_dim, sparse_inputs_slots,
    ...
    def create_optimizer(self, dy_model, config):
        ...
        optimizer = paddle.optimizer.Adagrad(
            learning_rate=lr, epsilon=1e-06, parameters=dy_model.parameters(), initial_accumulator_value=1e-3)
        return optimizer
